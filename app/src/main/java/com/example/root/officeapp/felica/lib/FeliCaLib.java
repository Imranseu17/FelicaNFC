 ...
 */
package com.example.root.officeapp.felica.lib;

import android.os.Parcel;
import android.os.Parcelable;

import com.example.root.officeapp.felica.FeliCaException;
import com.example.root.officeapp.felica.IFeliCaByteData;
import com.example.root.officeapp.felica.command.IFeliCaCommand;
import com.example.root.officeapp.nfc.NfcException;
import com.example.root.officeapp.nfc.NfcWrapper;
...
public final class FeliCaLib {
    ...
    public static class IDm implements Parcelable, IFeliCaByteData {
        ...
        public static final Creator<IDm> CREATOR =
            new Creator<IDm>() {
    ...
    public static class PMm implements Parcelable, IFeliCaByteData {
        /** Parcelable need CREATOR field **/
        public static final Creator<PMm> CREATOR =
            new Creator<PMm>() {
    ...
    */
    ...
    public static class MemoryConfigurationBlock extends Block implements IFeliCaByteData {
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append("Memory configuration block(MC)\n");
