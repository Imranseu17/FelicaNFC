...
public class GridMenuPageActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        read.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(GridMenuPageActivity.this, ReadCard.class));
            }
        });
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(GridMenuPageActivity.this, LoginActivity.class));
            }
        });
        ...
        settings.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(GridMenuPageActivity.this, SettingsActivity.class));
            }
        });
        ...
        accountSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(GridMenuPageActivity.this, AccountSearchActivity.class));
            }
        });
        ...
        cardInspect.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(GridMenuPageActivity.this, InspectCardActivity.class));
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.listView) {
            startActivity(new Intent(GridMenuPageActivity.this,ListMenuPageActivity.class));
        }

        if (id == R.id.recycleView) {
            startActivity(new Intent(GridMenuPageActivity.this,RecycleViewActivity.class));
        }
