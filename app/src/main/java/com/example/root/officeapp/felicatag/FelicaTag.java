...
public class FelicaTag extends NfcTag {
    ...
    public SystemCode[] getSystemCodeList(IDm idm) throws NfcException {
        ...
        for (int i = 0; i < num; i++) {
            retCodeList[i] = new SystemCode(Arrays.copyOfRange(retBytes,
                    11 + i * 2, 13 + i * 2));
            System.out.println(retCodeList[i]);
        }
        return retCodeList;
    }
    ...
    public static class CommandPacket {
        ...
        public String toString() {
            ...
            sb.append("FeliCa command packet \n");
            sb.append(" Command name:" + Util.getHexString(this.commandCode) + "\n");
            sb.append("Data length: " + Util.getHexString(this.length) + "\n");
            sb.append(" Command code : " + Util.getHexString(this.commandCode)
                    + "\n");
            if (this.idm != null)
                sb.append(" " + this.idm.toString() + "\n");
            sb.append(" Data: " + Util.getHexString(this.data) + "\n");
            return sb.toString();
        }
    ...
    public static class IDm {
        ...
        public String toString() {
            ...
            sb.append("IDm (8byte) : " + Util.getHexString(this.getBytes())
                    + "\n");
            sb.append(" Manufacturer code: " + Util.getHexString(this.manufactureCode)
                    + "\n");
            sb.append(" Card identification number:\n");
            sb.append("   Manufacturing equipment:"
    ...
    public static class PMm {
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append("PMm(Manufacturing parameters)\n");
            sb
                    .append(" IC code(2byte): " + Util.getHexString(this.icCode)
                            + "\n");
            sb.append("   ROM Type: " + Util.getHexString(this.icCode, 0, 1)
                    + "\n");
            sb.append("IC Type: " + Util.getHexString(this.icCode, 1, 1)
                    + "\n");
            sb.append(" Maximum response time parameter(6byte)\n");
            sb.append("  B3(request service):"
                    +Util.getBinString(this.maximumResponseTime, 0, 1) + "\n");
            sb.append("  B3(request service) Dec:"
                    +Integer.parseInt(Util.getBinString(this.maximumResponseTime, 0, 1),2)  + "\n");
            sb.append("  B4(request response):"
                    + Util.getBinString(this.maximumResponseTime, 1, 1) + "\n");
            sb.append("  B4(request response) Dec:"
                    + Integer.parseInt(Util.getBinString(this.maximumResponseTime, 1, 1),2)  + "\n");
            sb.append("  B5(authenticate):"
                    + Util.getBinString(this.maximumResponseTime, 2, 1) + "\n");
            sb.append("  B5(authenticate) Dec:"
                    + Integer.parseInt(Util.getBinString(this.maximumResponseTime, 2, 1),2)  + "\n");
            sb.append("  B6(read):"
                    + Util.getBinString(this.maximumResponseTime, 3, 1) + "\n");
            sb.append("  B6(read) Dec:"
                    + Integer.parseInt(Util.getBinString(this.maximumResponseTime, 3, 1),2)  + "\n");
            sb.append("  B7(write):"
                    + Util.getBinString(this.maximumResponseTime, 4, 1) + "\n");
            sb.append("  B7(write) Dec:"
                    + Integer.parseInt(Util.getBinString(this.maximumResponseTime, 4, 1),2)  + "\n");
            sb.append("  B8():"
                    + Util.getBinString(this.maximumResponseTime, 5, 1) + "\n");
            sb.append("  B8() Dec:"
                    + Integer.parseInt(Util.getBinString(this.maximumResponseTime, 5, 1),2)  + "\n");
            return sb.toString();
        }
    }
    ...
    public static class SystemCode {
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append("System code : " + Util.getHexString(this.systemCode));
            return sb.toString();
        }
