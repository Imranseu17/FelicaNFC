...
public class NFCcheckActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nfccheck);
        setTitle(" NFC Card Check ");
        ...
        if (MainApplication.message == "Japanese") {
            text.setText(getResources().getString(R.string.nfccheck_japan));
        } else if (MainApplication.message == "Bangla") {
            text.setText(getResources().getString(R.string.nfccheck_ban));
        } else if (MainApplication.message == "English") {
            text.setText(getResources().getString(R.string.nfccheck_eng));
        }
